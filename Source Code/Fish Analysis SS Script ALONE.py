...
with warnings.catch_warnings():
    ...
    for model in models:
        # Load data
        DRIVE_PATH = f"E:\EXP3_SS_ALONE_CSV\ALONE_SS_{model}.csv"
        ...
        # plt.savefig(f'E:\EXP3_SS_ALONE_CSV\Alone_{model}_distance.png')
        plt.close()
        ...
        output_df.to_csv(f"E:\EXP3_SS_ALONE_CSV\ALONE_FISH_{model}_Self_Segregation_by_Episode.csv")
        ###############################################################################
        ...
        plt.savefig(f'E:\EXP3_SS_ALONE_CSV\ALONE_{model}_SS.png')
        plt.close()
