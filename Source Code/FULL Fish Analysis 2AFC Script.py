...
for model_name, model_data in models.items():
    ...
    results_df.to_csv(f"{logs_dir}/FULL_{model_name}_2AFC_SocialPreference_by_Episode.csv", index=False)
    print(f"Results Logged to {logs_dir}/FULL_{model_name}_2AFC_SocialPreference_by_Episode.csv")
    ...
    save_name = f"{logs_dir}/2AFC_FULL_{model_name}.png"
