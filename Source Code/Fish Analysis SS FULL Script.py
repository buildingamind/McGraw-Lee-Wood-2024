...
with warnings.catch_warnings():
    ...
    for model in models:
        # Load data
        DRIVE_PATH = f"E:\EXP3_SS_FULL_CSV\FULL_SS_{model}.csv"
        ...
        # plt.savefig(f'E:\EXP3_SS_FULL_CSV\Full_{model}_distance.png')
        plt.close()
        ...
        output_df.to_csv(f"E:\EXP3_SS_FULL_CSV\FULL_FISH_{model}_Self_Segregation_by_Episode.csv")
        ###############################################################################
        ...
        plt.savefig(f'E:\EXP3_SS_FULL_CSV\FULL_{model}_SS.png')
        plt.close()
